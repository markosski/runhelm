...
- [ ] 5.3 Add focused tests for the human-input session-handling plumbing available in this change; defer end-to-end human-input submission/resume tests to the human-input API change.
