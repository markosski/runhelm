...
- a core workflow state manager coordinates loading the current snapshot, applying the reducer, and asking storage to commit timestamped event records with the updated snapshot
